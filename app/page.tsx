...
import { ArrowRight, PieChart, Calendar, TrendingUp, Shield, Check } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary/20">
        ...
        <section className="py-12 sm:py-20 px-4">
          <div className="container mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 sm:mb-10 px-4">
              ...
              Every dollar has a purpose, every expense is tracked.
            </p>
            <Link 
              href="/app"
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
              <div className="p-6 rounded-xl bg-card/50 backdrop-blur hover:bg-card/80 transition-colors">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2">Monthly Planning</h3>
                <p className="text-sm sm:text-base text-muted-foreground">
                  Plan your budget month by month, adjusting as your needs change.
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl bg-card/50 backdrop-blur hover:bg-card/80 transition-colors">
                ...
                <p className="text-sm sm:text-base text-muted-foreground">
                  Track every expense in real-time with beautiful visualizations.
                </p>
              </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <div className="rounded-xl border bg-card p-6 sm:p-8">
                ...
                <p className="text-3xl font-bold mb-4">$0<span className="text-muted-foreground text-sm font-normal">/month</span></p>
              ...
              <div className="rounded-xl border bg-primary p-6 sm:p-8 relative">
                ...
                <p className="text-3xl font-bold mb-4 text-primary-foreground">$9<span className="text-primary-foreground/70 text-sm font-normal">/month</span></p>
              ...
              <div className="rounded-xl border bg-card p-6 sm:p-8">
                ...
                <p className="text-3xl font-bold mb-4">$29<span className="text-muted-foreground text-sm font-normal">/month</span></p>
                <ul className="space-y-3 mb-6">
                  <li className="flex items-center gap-2">
                    <Check className="h-5 w-5 text-primary" />
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-3xl mx-auto p-6 sm:p-8 rounded-2xl bg-primary/5 backdrop-blur">
              ...
              <p className="text-base sm:text-lg text-muted-foreground mb-6 sm:mb-8">
                Join thousands of others who have transformed their financial lives 
                with simple budgeting.
              </p>
              <Link 
                href="/app"
                className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-5 py-2.5 sm:px-6 sm:py-3 rounded-lg text-base sm:text-lg font-medium hover:bg-primary/90 transition-colors"
      ...
      <footer className="border-t py-6 sm:py-8 bg-card/50">
        <div className="container mx-auto px-4 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Simple Budget. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
