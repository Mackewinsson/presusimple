---
title: "Gastos en pareja: cómo compartir gastos sin peleas"
description: "Cómo compartir gastos en pareja y dividir gastos en pareja (50/50 o proporcional). Guía de finanzas en pareja + presupuesto conjunto. Prueba gratis 30 días."
date: "2026-07-10"
author: "Presusimple"
tags: ["gastos-en-pareja", "compartir-gastos-en-pareja", "presupuesto-en-pareja", "finanzas-en-pareja", "dividir-gastos"]
translationSlug: "budgeting-for-couples-split-expenses"
---
...
**Para dividir gastos en pareja:** elijan una estructura de cuentas (separadas, conjunta o mixta "lo tuyo, lo mío y lo nuestro"), decidan entre dividir 50/50 o proporcional a ingresos, y revisen el presupuesto juntos una vez al mes. El método "lo tuyo, lo mío y lo nuestro" con aportación proporcional suele ser el que menos fricción genera.

Esta guía cubre cómo **compartir gastos en pareja**, armar un **presupuesto en pareja** y **dividir gastos proporcionalmente** o al 50/50 — sin convertir la relación en una hoja de cálculo eterna.

---

## Cómo compartir gastos en pareja (3 métodos)

Antes de hablar de porcentajes, elijan *dónde* vive el dinero compartido. La estructura de cuentas define el día a día.
...
## Dividir gastos proporcionalmente vs 50/50
...
## Presupuesto en pareja: plantilla mensual
...
### ¿Cómo compartir gastos en pareja de forma justa?
Pueden usar 50/50, división proporcional a ingresos, o un presupuesto conjunto con categorías compartidas y personales. Lo importante es acordar el método y revisarlo cada mes.
...
### ¿Qué app sirve para dividir gastos en pareja?
Presusimple permite crear categorías compartidas, registrar [gastos diarios](/es/blog/como-controlar-gastos-diarios) y ver el [presupuesto mensual](/es/blog/como-hacer-un-presupuesto-mensual) en un solo lugar. Hay prueba gratuita de 30 días.
...
### ¿Cómo ahorramos juntos para comprar una casa?
Traten la entrada como una meta compartida más del presupuesto conjunto, con una categoría y aportación mensual fija de cada uno. Nuestra [guía para ahorrar para una casa](/es/blog/como-ahorrar-para-comprar-una-casa) explica cómo calcular la meta y el plazo.

### Uno de los dos tiene deudas de antes de la relación, ¿cómo lo atacamos en equipo?
Sigan pagando los mínimos de todas las deudas y, si deciden ayudar como pareja, apliquen el [método de Bola de Nieve o Avalancha](/es/blog/como-pagar-deudas-rapido) usando el dinero extra que definan en su presupuesto conjunto.
