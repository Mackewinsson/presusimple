...
const NewCategoryForm: React.FC<NewCategoryFormProps> = ({ 
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (budgetAmount > totalAvailable) {
      toast.error(`Cannot budget more than available amount (${formatMoney(totalAvailable)})`);
      return;
    }
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            <Input
              ...
              className="w-full h-8"
            />
            <div className="absolute right-0 top-0 h-8 px-2 flex items-center text-sm text-muted-foreground pointer-events-none">
