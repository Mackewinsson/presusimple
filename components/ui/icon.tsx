...
export const Icon: React.FC<IconProps> = ({ className = "", size = 24 }) => {
  return (
    ...
    >
      ...
      <path d="M12 6V8" stroke="#F59E0B" strokeWidth="2" strokeLinecap="round"/>
      <path d="M12 12V14" stroke="#F59E0B" strokeWidth="2" strokeLinecap="round"/>
      <path d="M8 6H16" stroke="#F59E0B" strokeWidth="2" strokeLinecap="round"/>
      <path d="M8 12H16" stroke="#F59E0B" strokeWidth="2" strokeLinecap="round"/>
      <path d="M8 18H16" stroke="#F59E0B" strokeWidth="2" strokeLinecap="round"/>
    </svg>
  );
}; 